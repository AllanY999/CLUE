...
class SideInfo(object):
    ...
    def process(self):
        ...
        fname4, fname5, fname6 = self.folder_to_make + '/self.obj_list', self.folder_to_make + '/self.ent2id', self.folder_to_make + '/self.rel2id'
        ...
        if not checkFile(fname1) or not checkFile(fname2):
            ...
            print('ent1List:', len(ent1List))
            print('ent2List:', len(ent2List))
            ...
            for i in range(21856,1045274):#id for CKB entities
                if str(i) not in self.ent_list:
                    self.ent_list.append(str(i))


            print('self.ent_list:', len(self.ent_list))
            print('self.sub_list:', len(self.sub_list))
            print('self.obj_list:', len(self.obj_list))
            print('self.rel_list:', len(self.rel_list))
            ...
            print('self.sub2id:', len(self.sub2id))
            print('self.obj2id:', len(self.obj2id))
            print('self.ent2id:', len(self.ent2id))
            print('self.rel2id:', len(self.rel2id))

            self.isSub = {}
            for sub in self.sub_list:
                self.isSub[self.ent2id[sub]] = 1
            print('self.isSub:', len(self.isSub))
            ...
            print('self.ent_freq:', len(self.ent_freq))
            print('self.rel_freq:', len(self.rel_freq))
            print('self.id2ent:', len(self.id2ent))
            print('self.id2rel:', len(self.id2rel))
            print('self.id2sub:', len(self.id2sub))
            print('self.id2obj:', len(self.id2obj))
            ...
            print('self.trpIds:', len(self.trpIds))
